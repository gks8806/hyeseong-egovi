       ...
       <form name="frm" action ="<c:url value='/admin/board${prefix}/selectBoard.do'/>" method="post">
	       ...
	       <div class="col-2" style="display:inline-block" >
	        ...
	        <div class="search" style="display:inline">
				...
				<div class="button" style="display:inline">
			     <button type="button" onclick='location.href="<c:url value='/admin/bbs${prefix}/insertBoardArticle.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>"'>새글쓰기</button>
			    </div>
	        </div>
    	</form>
	</div>
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                ...
                <table class="table table-hover text-nowrap">
                  <tr>
		           <td> <button type="button" onclick='location.href="<c:url value='/admin/bbs${prefix}/insertBoardArticle.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>"' class="btn btn-primary">CREATE</button>
		           </td>
		           <td>
		          <style>
                  .active .page-link{
